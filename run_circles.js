const fs = require('fs');
let code = fs.readFileSync('app/admin/circles/page.tsx', 'utf8');

code = code.replace(/export default function CircleManagement/, 'export function GlobalCirclesDialog');
